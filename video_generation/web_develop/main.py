...
async def text2vid(text_prompt: str):
    # model_id = "runwayml/stable-diffusion-v1-5"
    img = predict(text_prompt)
...
# --------------------------------------------------------------------------
@app.get("/predictv1")
def text2vid_gradio(text_prompt: str):
    # model_id = "runwayml/stable-diffusion-v1-5"
    video_path = predict(text_prompt)
...
description = """### Welcome to our text-to-video application (using damo-vilab/text-to-video-ms-1.7b)"""


def get_image(text_prompt: str):
    # print(11111111111)
    response = text2vid_gradio(text_prompt)
...
demo = gr.Interface(fn=get_image,
                    ...
                    outputs = gr.Video(), title = title, description=description, 
